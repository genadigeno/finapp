...
final class DatabaseRoles {
    ...
    static Connection migrator() throws SQLException {
        return DriverManager.getConnection(
                required("finapp.db.url"),
     ...
     */
    static void assertCannotBypassPrivileges(Connection connection) throws SQLException {
