 ...
 * P0-TSK-010), typed identifiers (P0-TSK-012), correlation and causation identifiers and the
 * event envelope (P0-TSK-018) exist. The {@code Clock} abstraction is {@code java.time.Clock}
 * itself, injected rather than wrapped (P0-TSK-013).
 *
