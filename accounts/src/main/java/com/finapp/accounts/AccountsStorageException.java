...
/**
 * An accounts row could not be written or read.
 *
 ...
 */
public final class AccountsStorageException extends RuntimeException {

    @Serial private static final long serialVersionUID = 1L;

    public AccountsStorageException(String message) {
        super(message);
    }
}
