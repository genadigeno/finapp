...
**Eight mutations, all caught.** The predicate removal is caught **twice** — by the build rule and
by the behavioural suite, which is the `P1-TSK-020` argument that two controls blind in different
directions are not a duplication. 832 hermetic tests, 381 database tests.
