...
**M1.1 — A person exists and is registered.** `P1-TSK-001` … `P1-TSK-006`; **4 of 6 complete.**
...
**None in progress.** `P1-TSK-004` completed 2026-09-04. **Next: `P1-TSK-005`** — the Party,
Customer and Identity aggregates.
...
The three aggregates, their state machines, their schemas and their constraints. ADR-0029, and
`DELIVERY_PLAN.md` §17 names collapsing them as the phase's top risk. The first task in Phase 1 to
create a table, and therefore the first to meet the column-classification guard the `P1-TSK-003`
gate widened to cover the new schemas.
