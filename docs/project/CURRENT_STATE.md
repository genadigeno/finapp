...
**1 of 4 complete.** Started 2026-09-07.
...
**None in progress.** `P1-TSK-013` completed 2026-09-07. **M1.3 opens, 1 of 4.**
**Next: `P1-TSK-014`** — revocation, immediate and multi-instance.
...
**Five mutations, all caught.** 739 hermetic tests, 289 database tests.
