...
**Five mutations. Three caught, one caught twice, one survived correctly** — having removed redundant
code. 754 hermetic tests, 297 database tests.
