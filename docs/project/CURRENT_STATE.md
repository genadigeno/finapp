...
**None in progress.** `P1-TSK-019` completed 2026-09-07. **M1.4 closes, 3 of 3.**
**Next: `P1-TSK-020`** — roles, permissions and the boundary check, opening M1.5.
...
**Six mutations, all caught** — including a new un-enumerated session path, which is the guard's
whole purpose. 812 hermetic tests, 369 database tests.
